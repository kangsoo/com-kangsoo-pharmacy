 ...
 */
public class ShoppingCategoryListFragment extends ItemListFragment<ShoppingCategory> implements
    ...
    public Loader<List<ShoppingCategory>> onCreateLoader(int id, Bundle args) {
        return new AsyncLoader<List<ShoppingCategory>>(getActivity()) {
            ...
            public List<ShoppingCategory> loadInBackground() {
                ...
                Collections.sort(filters, ShoppingCategoryListFragment.this);
                return filters;
            }
        };
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //kskim to-do : Display Pop-up
//        startActivity(IssueBrowseActivity.createIntent(filter));
        cameraFragmentListener.onMovetoDisplayShoppingItem(filter);
    ...
    protected SingleTypeAdapter<ShoppingCategory> createAdapter(List<ShoppingCategory> items) {
        return new ShoppingCategoryListAdapter(
                getActivity().getLayoutInflater(),
                items.toArray(new ShoppingCategory[items.size()]),
                avatars);
    }
