...
import com.kangsoo.pharmacy.listener.CameraOrientationListener;
import com.kangsoo.pharmacy.view.CameraPreview;
...
*/
    ...
    public void takePicture() {
        ...
        AudioManager mgr1 = (AudioManager) mActivity.getSystemService(Context.AUDIO_SERVICE);
        mgr1.setStreamMute(AudioManager.STREAM_SYSTEM, true);

        // focus Take a picture
...
//        camera.takePicture(null, null, this);
    ...
    private final ShutterCallback shutterCallback = new Camera.ShutterCallback() {
